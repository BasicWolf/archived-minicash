# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-06-30 07:36
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('minicash_core', '0008_auto_20170527_2014'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='record',
            name='asset_from',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='from_asset_records', to='minicash_core.Asset'),
        ),
        migrations.AlterField(
            model_name='record',
            name='asset_to',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='to_asset_records', to='minicash_core.Asset'),
        ),
        migrations.AlterField(
            model_name='tag',
            name='description',
